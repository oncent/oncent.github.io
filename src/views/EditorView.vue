<template>
  <div class="w-full h-full flex flex-col justify-between">
    ...
    <div class="w-full h-20 rounded-lg flex p-2 pb-0">
    ...
    >
      <div class="mb-1 flex justify-between items-center p-2">
        <div class="flex items-center">
          ...
          >
            <i class="icon-xs icon-image text-[white]"></i>
          </div>
          <div
            class="mx-1 p-2 flex justify-center items-center rounded-full transition-all hover:(bg-stone-700) active:(bg-stone-500)"
          >
          ...
          <div
            class="p-2 w-30 rounded-full transition-all hover:(bg-stone-700) active:(bg-stone-500)"
          >
...
const { type, time, cateId, categories, comment, result, onConfirm, goBack } =
  useEditor(router);
